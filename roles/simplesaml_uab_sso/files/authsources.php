...
$config = array(
  ...
  'default-sp' => array(
    'saml:SP',
    'privatekey' => '/etc/xdmod/simplesamlphp/cert/uabgrid-incommon-key.pem',
    'certificate' => '/etc/xdmod/simplesamlphp/cert/uabgrid-incommon-cert-2048-20yr.pem',
    'idp' => 'urn:mace:incommon:uab.edu', 
